...
def max_ent(N):
    ''' Function that constructs the density matrix associated to the maximum entangled state,
        having an Hilbert space of dimension N.
        ...
        -------
        out : ndarray
                Matrix of dimension (N**2 x N**2) that represents the density matrix of a 
...
def choi_st(N,Lind_matr,t):
    ''' Function that calculates the Choi-state associated to the CPT channel Phi(t).
        ...
        -------
        out : ndarray
            Matrix of dimension (N**2 x N**2) that represents the Choi-state associated to
            the CPT channel Phi(t) obtained from the Lindbladian matrix in input.
    '''
